      ...
      >
        ...
        <div className="bg-white dark:bg-[#0A0A0A] border border-gray-200 dark:border-gray-800 rounded-3xl shadow-2xl overflow-hidden">
            <div className="p-8">
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold font-mono dark:text-white">Welcome Back</h2>
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">Enter your credentials to access your workspace.</p>
                    {isMockMode && (
            ...
            <div className="p-4 bg-gray-50 dark:bg-black/50 border-t border-gray-200 dark:border-gray-800 text-center">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <button onClick={onSignup} className="font-bold text-black dark:text-white hover:underline">
                        Sign up
                    </button>
                </p>
            </div>
